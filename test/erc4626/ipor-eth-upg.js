...
// Developed and tested at blockNumber 46841200
...
describe("Base Mainnet IPOR Lending ETH", function() {
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [
        {"aerodrome": [farm, underlying.address]},
      ],
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      await depositVault(farmer1, underlying, vault, 10000);
      ...
      for (let i = 0; i < hours; i++) {
        ...
        if (i % 3 == 0) {
          await usdcToken.transfer(strategy.address, new BigNumber(5000000), {from: usdcWhale});
        }
