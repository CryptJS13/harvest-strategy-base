...
const Strategy = artifacts.require("MorphoVaultStrategyMainnet_MW_EURC_V2");

// Developed and tested at blockNumber 46627500

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Base Mainnet Morpho Vault V2 Moonwell EURC", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x1b4392a3Ed3cB50E9C81aae038663AeB92470c7e";
  let morphoToken;
